...
export function OneLinerExams() {
    ...
    useEffect(() => {
        ...
        api.get(`/onelinerexam/next-order-index?${query}`, { noPrefix: true })
            .then(res => {
        ...
        <div class="materials-page">
            <div class="page-header">
                <div class="page-header-titles">
                    ...
                    <h1>One-Liner Exams</h1>
                    <p class="page-subtitle">Short-answer exams for rapid concept checks.</p>
                            ...
                            <tbody>
                                {filters.visible.map(item => (
                                    <tr key={item._id}>
                                        <td>
                                            <div class="identity">
                                                <div class="avatar avatar-sm" style={{ background: 'var(--success)' }}><Icons.Reports /></div>
